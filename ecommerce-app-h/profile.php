	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand">Seafood Shop</a>
			</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-2">
				...
				<!--<div class="nav nav-pills nav-stacked">
					<li class="active"><a href="#"><h4>Supplier</h4></a></li>
					<li><a href="#">Categories</a></li>
					<li><a href="#">Categories</a></li>
					<li><a href="#">Categories</a></li>
					<li><a href="#">Categories</a></li>
		...
		<script>
			// tìm phần tử ul trong HTML 
var pagination = document.getElementById("pageno");

// lấy danh sách các phần tử li trong phần tử ul 
var pages = pagination.getElementsByTagName("li");

// lặp lại danh sách các phần tử li để thêm sự kiện khi người dùng nhấp vào nó 
for (var i = 0; i < pages.length; i++) {
  pages[i].addEventListener("click", function() {
    // hiển thị số trang được nhấp vào 
    console.log(this.innerText);
    
    // chuyển đến trang được nhấp vào bằng cách thay đổi đường dẫn trên thanh địa chỉ
    window.location.href = "profile.php" + this.innerText;
  });
}
</script>
		<div class="row">
